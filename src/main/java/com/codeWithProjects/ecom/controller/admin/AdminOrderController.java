...
public class AdminOrderController {
    ...
    public ResponseEntity<List<OrderDTO>> getOrdersByFilter(@RequestParam(required = false) String name,
    ...
    public ResponseEntity<AnalyticsResponseDTO> getAnalytics() {
        return ResponseEntity.ok().body(adminOrderService.calculateAnalytics());
    }
